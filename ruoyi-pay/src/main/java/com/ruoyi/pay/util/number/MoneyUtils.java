package com.ruoyi.pay.util.number;
...
public class MoneyUtils {
     ...
     * @return 百分比金额
     */
    public static BigDecimal calculateRatePrice(BigDecimal price, Double rate) {
        return calculateRatePrice(price, rate, 0, RoundingMode.HALF_UP);
    }
     ...
     * @return 百分比金额
     */
    public static BigDecimal calculateRatePriceFloor(BigDecimal price, Double rate) {
        return calculateRatePrice(price, rate, 0, RoundingMode.FLOOR);
    }
     ...
     * @param roundingMode 舍入模式
     */
    public static BigDecimal calculateRatePrice(BigDecimal price, Number rate, int scale, RoundingMode roundingMode) {
        return price.multiply(NumberUtil.toBigDecimal(rate)) // 乘以
            .divide(BigDecimal.valueOf(100), scale, roundingMode); // 除以 100
    }
